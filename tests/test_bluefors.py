...
class TestSnowball:
    def test_pressure(self):
        line = r'snowball,metric_type=pressure,path=maxigauge\ 21-12-11 pressures="CH1,P1  ,1, 3.88E-6,0,1,CH2,P2  ,1, 2.87E-2,0,1,CH3,P3  ,1, 7.63E+2,0,1,CH4,P4  ,1, 8.39E+2,0,1,CH5,P5  ,1, 7.88E+0,0,1,CH6,P6,1, 2.09E+0,0,1," 1639209665000000000'
